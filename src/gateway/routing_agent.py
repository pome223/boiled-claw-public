...
- requests targeting the boiled-claw Control UI chat page (for example localhost:18789/chat) should prefer specialist=browser_automator with handoff_mode="direct".
