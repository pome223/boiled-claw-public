...
class ModelConfig(BaseModel):
    """モデル設定"""
    name: str = Field(..., description="Model name (e.g., gemini-3-flash-preview)")
...
class AppConfig(BaseModel):
    ...
    model: ModelConfig = Field(default_factory=lambda: ModelConfig(name="gemini-3-flash-preview"))
